...
exec 30 pi_acc_mc_1000_1000000.txt ./bin/pi_acc_mc  1000 1000000
exec 30 pi_acc_mc_10000_100000.txt ./bin/pi_acc_mc  10000 100000
exec 30 pi_acc_mc_1000000_1000.txt ./bin/pi_acc_mc  1000000 1000
...
exec 2  pi_seq_1e10.txt ./bin/pi_seq 10000000000

exec 6  pi_acc_1e11.txt ./bin/pi_acc 100000000000
exec 1  pi_seq_1e11.txt ./bin/pi_seq 100000000000

exec 30 mandel_acc_strict_i100_xy1000.txt ./bin/mandel_acc_strict -i 100 -xy 1000
exec 30 mandel_acc_seq_i100_xy1000.txt ./bin/mandel_seq -i 100 -xy 1000

exec 30 mandel_acc_strict_i6000_xy6000.txt ./bin/mandel_acc_strict -i 6000 -xy 6000
exec 5 mandel_acc_seq_i6000_xy6000.txt ./bin/mandel_seq -i 6000 -xy 6000
